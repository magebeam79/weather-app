...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\walde\PycharmProjects\weather-app\virtual-weather'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\walde\PycharmProjects\weather-app\virtual-weather\Scripts\deactivate.nu'
